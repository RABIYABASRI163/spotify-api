...
function Home() {
    ...
    const fetchToken = async () => {
      try {
        ...
        const response = await fetch('https://accounts.spotify.com/api/token', {
          ...
          body: 'grant_type=client_credentials&client_id=47d7f3b669d24d2294dd4a822ed23f4c&client_secret=0165ed65af3c4d7fb68582936f0dd723',
        });
  ...
  const playSong = (track) => {
    if (currentTrack && currentTrack.id === track.id && isPlaying) {
      ...
      audioRef.current.src = track.preview_url ||"https://api.spotify.com/v1/audiobooks/7iHfbu1YPACw6oZPAFJtqe" //preview URl
